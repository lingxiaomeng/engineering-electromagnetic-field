...
grid on
hold on;
title({'the plot of electric potential distribution of a line charge in the vacuum','-infinitesimal','11711913 孟令啸'},'fontsize',12) ;%title the figure
...
title({'Isopotential Line of Line charge Electric Field in vacuum','-infinitesimal','11711913 孟令啸'},'fontsize',12) ;%title the figure
xlabel('X axis(unit:m)','fontsize',12);                    %label the x axis
ylabel('Y axis(unit:m)','fontsize',12);                    %label the y axis
...
hold on
contour(X0,Y0,V,Veq);
title({'Isopotential Line and Power Line of Line charge Electric Field in vacuum (expressed by smooth continuous Curves)','-infinitesimal','11711913 孟令啸'},'fontsize',12) ;%title the figure
xlabel('X axis(unit: m)', 'fontsize', 12);                    % label the x axis
