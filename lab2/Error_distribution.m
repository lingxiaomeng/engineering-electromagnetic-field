...
title({'The error distribution (n=100)','-integration','11711913 孟令啸'},'fontsize',12) ;% title the figure
xlabel('X axis(unit:m)','fontsize',12);                    %label the x axis
ylabel('Y axis(unit:m)','fontsize',12);  %label the y axis
V1=Infinitesimal(50);
figure(2)
mesh(X0,Y0,abs(V2-V1));
title({'The error distribution (n=50)','-integration','11711913 孟令啸'},'fontsize',12) ;% title the figure
xlabel('X axis(unit:m)','fontsize',12);                    %label the x axis
ylabel('Y axis(unit:m)','fontsize',12);  %label the y axis
...
figure(3)
mesh(X0,Y0,abs(V2-V1));
title({'The error distribution (n=20)','-integration','11711913 孟令啸'},'fontsize',12) ;% title the figure
xlabel('X axis(unit:m)','fontsize',12);                    %label the x axis
ylabel('Y axis(unit:m)','fontsize',12);  %label the y axis
